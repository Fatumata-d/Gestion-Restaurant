...
Route::post('/corbeille/commande', [CommandeController::class, 'ajouterALaCorbeille'])->name('commande.ajouterALaCorbeille');
Route::post('/corbeille/reservation', [ReservationController::class, 'ajouterALaCorbeille'])->name('reservation.ajouterALaCorbeille');
