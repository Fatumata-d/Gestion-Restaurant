...
Route::get('/coordonees1', [CommandeController::class, 'Client'])->name;
Route::get('/coordonnees', [ReservationController::class, 'CoordonneesClient']);
...
Route::post('/enregistrercoordonnees', [CommandeController::class, 'EnregistrerCoordonnees']);
...
Route::get('/menu', [MenuController::class, 'menu2']);
...
Route::post('/selectionner-plats', [CommandeController::class, 'selectionnerPlats']);
Route::get('/stocks_update', [MouvementStockController::class, 'formulaire']);
Route::post('/valider', [ReservationController::class, 'reserver']);
Route::post('/verifier', [ReservationController::class, 'verifier']);
