    ...
    <div class="card mb-3" style="max-width: 1300px;border-color: transparent;background-color:#F7F4EC;">
        <div class="row g-0">
            ...
            <div class="card-body" style="background-color:#F9F6ED ;">
                ...
                <p class="card-text">UN RESTAURANT japo MODERNE POUR DECOUVRIR L'ART DE LA CUISINE JAPONAISE.<br>VENEZ COMMANDER VOS PLATS<br>RESERVER A L'AVANCE VOS TABLES<br>PROFITER EN FAMILLE AMIS OU EN AMOUREUX.<br>ET TOUT A UN PRIX ABORDABLE!<br>VOUS VOUS SENTIREZ A L'AISE ET DETENDU</p>
            </div>
            <br>
