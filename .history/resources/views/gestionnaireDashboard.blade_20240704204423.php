...
@section('content')
                        ...
                        <table class="table table-bordered">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><input type="checkbox" class="check-commande" data-id="{{ $commande->id }}"></td>
                                </tr>
                                @endforeach
                            </tbody>
                        </table>
                        ...
                        <table class="table table-bordered">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><input type="checkbox" class="check-reservation" data-id="{{ $reservation->id }}"></td>
                                </tr>
                                @endforeach
                            </tbody>
                        </table>
    ...
    <script>
        $(document).ready(function() {
            $('.check-commande').change(function() {
                if (this.checked) {
                    var id = $(this).data('id');
                    $.ajax({
                        url: "{{ route('commande.ajouterALaCorbeille') }}",
                        method: 'POST',
                        data: {
                            _token: "{{ csrf_token() }}",
                            id: id
            ...
            $('.check-reservation').change(function() {
                if (this.checked) {
                    var id = $(this).data('id');
                    $.ajax({
                        url: "{{ route('reservation.ajouterALaCorbeille') }}",
                        method: 'POST',
                        data: {
                            _token: "{{ csrf_token() }}",
                            id: id
