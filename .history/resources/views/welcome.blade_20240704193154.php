...
@section('content')
    ...
    <div class="card mb-3" style="max-width: 1300px;border-color: transparent;">
        <div class="row g-0">
            ...
            <div class="text-center" style="background-color:#FDFAF5;">
                <img src="{{ asset('8.jpg') }}" class="rounded-circle me-2  text-center sushi-image" alt="Image1" style="width: 150px; height: 150px;">
            </div>
