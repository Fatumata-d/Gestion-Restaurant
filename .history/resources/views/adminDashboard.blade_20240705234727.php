...
<html lang="fr">
    ...
    <div class="dashboard-header">
        <h1 class="m-0">Tableau de Bord Administratif</h1>
    
        <form action="{{ route('deconnecter') }}" method="POST" class="logout-btn">
            @csrf
        ...
        <br>
        <div class="card-body" style="background-color:#F3F0EB ">
            <div class="row">
                <div class="col-md-4">
                    <div class="card">
                ...
                <div class="col-md-4 offset-md-2">
                    <div class="card">
                        ...
                        <div class="card-body text-center">
                            ...
                            <a href="{{ route('gestionnaireDashboard') }}">Tableau de bord du Gestionnaire</a>
                        </div>
                    </div>
                </div>
                <div class="col-md-4">
