                ...
                <div class="col-md-4">
                    <div class="card">
                        ...
                        <div class="card-body text-center">
                            ...
                            <li><a href="{{ route('creerPlat') }}">Création Plat</a></li>
                        </div>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="card">
                        ...
                        <div class="card-body text-center">
                            <li><a href="{{ route('/fournisseurs_ingredients') }}">Les Fournisseurs et Les produits</a></li>
                            <li><a href="{{ route('/Plats_Ingredients') }}">Les plats et les Ingredients</a></li>
                        </div>
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="col-md-4 offset-md-2">
                    <div class="card">
                        ...
                        <div class="card-body text-center">
                            <li><a href="{{ route('/CreerGestionnaire') }}">Création Gestionnaire</a></li>
                            <li><a href="{{ route('/Gestionnaire_Systeme') }}">Les Gestionnaires Systeme</a></li>
                            <li><a href="{{ route('/gestionnaireDashboard') }}">Tableau de bord Gestionnaire</a></li>
                        </div>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="card">
                        ...
                        <div class="card-body text-center">
                            <li><a href="{{ route('/CreerFournisseurs') }}">Création Fournisseur</a></li>
                            <li><a href="{{ route('/Fournisseurs') }}">Les Fournisseurs</a></li>
                            <li><a href="{{ route('/CreerPersonnel') }}">Création Personnel</a></li>
                            <li><a href="{{ route('/Personnel_Restaurant') }}">Les Personnels du Restaurant</a></li>
                            <li><a href="{{ route('/Creerresponsabilite') }}">Création Poste</a></li>
                            <li><a href="{{ route('/Responsabilite') }}">Les Postes disponibles</a></li>
                        </div>
                    </div>
                </div>
            </div>
