...
@section('content')
                        ...
                        <table class="table table-bordered">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><button class="deleteRow">Supprimer</button></td>
                                </tr>
                                @endforeach
                            </tbody>
                        </table>
    ...
    // Fonction pour masquer une ligne et enregistrer son état dans localStorage
            function masquerLigne() {
                $(this).closest('tr').hide();
                // Récupérer l'index de la ligne dans le tableau
                var index = $(this).closest('tr').index();
                // Enregistrer l'index de la ligne masquée dans localStorage
                localStorage.setItem('ligneMasquee', index);
            }

    // Vérifier s'il y a une ligne masquée enregistrée dans localStorage
            var ligneMasqueeIndex = localStorage.getItem('ligneMasquee');
            if (ligneMasqueeIndex !== null) {
                // Masquer la ligne correspondante au chargement de la page
                $('tr').eq(ligneMasqueeIndex).hide();
            }

    // Attacher l'événement click au bouton ou lien avec la classe .deleteRow
            $('.deleteRow').click(masquerLigne);
});
