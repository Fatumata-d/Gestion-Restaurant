...
@section('content')
    ...
    <div class="card mb-3" style="max-width: 1300px;border-color: transparent;background-color:#F7F4EC;">
        <div class="row g-0">
            ...
            <div class="col-md-8">
            <div class="card-body" style="background-color:#F9F6ED ;">
                <h1 class="card-title">BIENVENUE A SO SUSHI</h1>
                <p class="card-text">UN RESTAURANT JAPONAIS MODERNE POUR DECOUVRIR L'ART DE LA CUISINE JAPONAISE.<br>VENEZ COMMANDER VOS PLATS<br>RESERVER A L'AVANCE VOS TABLES<br>PROFITER EN FAMILLE AMIS OU EN AMOUREUX.<br>ET TOUT A UN PRIX ABORDABLE!<br>VOUS VOUS SENTIREZ A L'AISE ET DETENDU</p>
            </div>
            <br>
            <div class="card-body text-center" style="background-color:#F9F6ED;">
