...
Route::get('/gestionnaire_systeme', [GestionnaireSystemeController::class, 'listeGestionnaire'])->name('Gestionnaire_Systeme');
...
Route::delete('/ingredients/{id}', [IngredientController::class, 'supprimer'])->name('ingredients.supprimer');
...
Route::get('/personnel_restaurant', [PersonnelRestaurantController::class, 'listePersonnels'])->name('Personnel_Restaurant');
...
Route::get('/administration', [AdminController::class, 'index'])->name('adminDashboard');
Route::get('/login', [AuthController::class, 'login'])->name('loginPage');
Route::post('/connection', [AuthController::class, 'connecter'])->name('validerLogin');
Route::post('/deconnecter', [AuthController::class, 'deconnecter'])->name('deconnecter');
