...
@section('content')
    ...
    <head>
        ...
        <title>Ajouter un Personnel du Restaurant</title>
    </head>
    <body>
            ...
            <div class="row justify-content-center">
                <div class="col-md-6">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form action="{{ route('CreationPerso') }}" method="POST">
                                @csrf
                                <div class="mb-3">
                                ...
                                <div class="mb-3">
                                    <label for="Responsabilité" class="form-label">Responsabilité</label>
                                    <select name="Responsabilité" id="Responsabilité" class="form-select" required>
                                        @foreach($responsabilites as $responsabilite)
                                            <option value="{{ $responsabilite->id }}">{{ $responsabilite->Nom_Responsabilité}}</option>
                                        @endforeach
                                    </select>
                                </div>
                                <div class="mb-3">
